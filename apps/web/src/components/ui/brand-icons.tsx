...
/**
 * Ícones oficiais das plataformas de mensageria (paths via Simple Icons).
 * Cor herdada via currentColor — controle via className text-*.
 */
...
/**
 * Helper pra mapear ChannelType -> componente.
 * Use direto em arrays: ChannelIcon[canal] retorna o componente certo.
 */
